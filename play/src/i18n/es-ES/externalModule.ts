...
const externalModule: DeepPartial<Translation["externalModule"]> = {
    ...
    discord: {
        ...
        explainText:
            "Al conectar tu cuenta de Discord aquí, podrás recibir tus mensajes directamente en el chat de Arcade. Después de sincronizar un servidor, crearemos las salas que contiene, solo tendrás que unirte a ellas en el chat de Arcade.",
        ...
        guildExplain: "Selecciona los canales que deseas agregar a la interfaz de chat de Arcade.\n",
    },
    outlook: {
        signIn: "Iniciar sesión con Outlook",
        popupScopeToSync: "Conectar mi cuenta de Outlook",
        popupScopeToSyncExplainText:
            "Necesitamos conectarnos a tu cuenta de Outlook para sincronizar tu calendario y/o tus tareas. Esto te permitirá ver tus reuniones y tareas en Arcade y unirte a ellas directamente desde el mapa.",
    ...
    google: {
        ...
        popupScopeToSyncExplainText:
            "Necesitamos conectarnos a tu cuenta de Google para sincronizar tu calendario y/o tus tareas. Esto te permitirá ver tus reuniones y tareas en Arcade y unirte a ellas directamente desde el mapa.",
        popupScopeToSyncCalendar: "Sincronizar mi calendario",
        popupScopeToSyncTask: "Sincronizar mis tareas",
        popupCancel: "Cancelar",
