...
const notification: DeepPartial<Translation["notification"]> = {
    ...
    help: {
        ...
        content:
            "No te pierdas ninguna discusión. Activa las notificaciones para ser notificado cuando alguien quiera hablar contigo, incluso si no estás en la pestaña de Arcade.",
        firefoxContent:
