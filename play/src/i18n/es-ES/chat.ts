...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    matrixSettings: {
        ...
        accountDataSection: "Arcade (in-game)",
        ...
        publishWokaToMatrixProfileConfirmWarning:
            "This replaces your Matrix profile display name and avatar on the server. Any name or photo set elsewhere (e.g. in Element) will be overwritten. Continue only if you want your Arcade name and WOKA to become your public Matrix profile.",
