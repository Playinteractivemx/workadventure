...
const warning: DeepPartial<Translation["warning"]> = {
    ...
    browserNotSupported: {
        ...
        message: "Su navegador ({browserName}) ya no es compatible con Arcade.",
        description:
            "Su navegador es demasiado antiguo para ejecutar Arcade. Por favor, actualícelo a la última versión para continuar.",
        whatToDo: "¿Qué puede hacer?",
        option1: "Actualizar {browserName} a la última versión",
        option2: "Salir de Arcade y usar un navegador diferente",
        updateBrowser: "Actualizar navegador",
        leave: "Salir",
    },
    pwaInstall: {
        title: "Instalar Arcade",
        description:
        ...
        descriptionIos:
            "Añade Arcade a tu pantalla de inicio para disfrutar de una mejor experiencia y un acceso rápido.",
        feature1Title: "Acceso rápido",
        feature1Description: "Abre Arcade desde tu menú Inicio, Dock o escritorio.",
        feature2Title: "Ventana de aplicación dedicada",
        feature2Description:
            "Mantén Arcade separado de las pestañas del navegador y encuéntralo de un vistazo en la barra de tareas.",
        feature3Title: "Iniciar con el ordenador",
        feature3Description: "Abre Arcade cuando se inicie tu dispositivo.",
        ...
        install: "Instalar la app Arcade",
