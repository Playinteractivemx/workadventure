...
const warning: BaseTranslation = {
    ...
    browserNotSupported: {
        ...
        message: "Your browser ({browserName}) is no longer supported by Arcade.",
        description: "Your browser is too old to run Arcade. Please update to the latest version to continue.",
        whatToDo: "What can you do?",
        option1: "Update {browserName} to the latest version",
        option2: "Leave Arcade and use a different browser",
    ...
    pwaInstall: {
        ...
        descriptionIos: "Add Arcade to your Home Screen for a better experience and quick access.",
        feature1Title: "Quick access",
        feature1Description: "Launch Arcade from your Start menu, Dock, or desktop.",
        feature2Title: "Dedicated app window",
        feature2Description:
            "Keep Arcade separate from your browser tabs and find Arcade at a glance in your taskbar.",
        feature3Title: "Start with your computer",
        feature3Description: "Launch Arcade when your device starts.",
