...
const menu: BaseTranslation = {
    ...
    settings: {
        ...
        microphone: {
            ...
            workAdventureNoiseSuppression: "Arcade noise suppression",
            workAdventureNoiseSuppressionDescription: "Process your microphone with Arcade's noise suppression.",
            recommended: "Recommended",
        ...
        privacySettings: {
            title: "Away mode",
            explanation:
                'While the Arcade tab in your browser is not visible. Arcade switches to "away mode"',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Arcade allows you to create an online space to communicate spontaneously with others. And it all starts with creating your own space. Choose from a large selection of prefabricated maps by our team.",
        },
        createMap: {
